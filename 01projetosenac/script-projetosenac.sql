CREATE DATABASE DB_PROJETOSENAC;
...
CID_EST_ID INT UNSIGNED NOT NULL,
CID_NOME VARCHAR(30) NOT NULL,
CONSTRAINT PRIMARY KEY (CID_ID),
CONSTRAINT FK_EST_CID FOREIGN KEY (CID_EST_ID) REFERENCES TB_ESTADOS(EST_ID)
);
...
(BAI_CID_ID,BAI_NOME)
VALUES
(3,'CAPIM MACIO'),(3,'CIDADE ALTA'),(4,'NOVA PARNAMIRIM');
...
ADD COLUMN CLI_CEP VARCHAR(9) NOT NULL;
...
VALUES
('LUAN','SILVA','1999-10-02',1,'701.087.594-40','59152-845',4,'RUA BORORÓ SIMÃO','230','LUANDK2@HOTMAIL.COM');
